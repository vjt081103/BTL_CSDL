...
/* Define MFRC522 SPI interface (change SPI1 to SPI2) */
...
void MFRC522_SPI_Init(void)
{
    ...
    RCC_APB2PeriphClockCmd(MFRC522_SPI_GPIO_RCC, ENABLE);     // Enable clock for GPIO

    RCC_APB1PeriphClockCmd(MFRC522_SPI_RCC, ENABLE);          // Enable clock for SPI2

    GPIO_InitStruct.GPIO_Pin = MFRC522_SCK_PIN | MFRC522_MISO_PIN | MFRC522_MOSI_PIN; // SCK, MISO, MOSI pins
    GPIO_InitStruct.GPIO_Mode = GPIO_Mode_AF_PP;
    GPIO_InitStruct.GPIO_Speed = GPIO_Speed_50MHz;
    GPIO_Init(MFRC522_SPI_GPIO, &GPIO_InitStruct);            // Initialize GPIO for SPI
...
void MFRC522_Init(void)
{
    ...
    RCC_APB2PeriphClockCmd(MFRC522_CS_RCC | MFRC522_RST_RCC | MFRC522_SPI_GPIO_RCC | RCC_APB2Periph_AFIO, ENABLE);
